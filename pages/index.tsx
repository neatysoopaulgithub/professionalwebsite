  ...
  >
    ...
    <div className="flex flex-1 items-center justify-end gap-8">
      ...
      >
        <a
          href="/about"
          className="block h-16 border-b-4 border-transparent leading-[4rem] hover:border-current hover:text-gray-800"
        >
          About
        </a>
      ...
      <div className="flex items-center">
        <div className="flex items-center border-x border-gray-100">
          <span className="border-e border-e-gray-100">
            <a
              href="/cart"
              className="grid h-16 w-16 place-content-center border-b-4 border-transparent hover:border-gray-800"
            >
              <svg
                className="h-4 w-4"
                fill="none"
    ...
    <div className="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
      ...
      <div className="relative flex items-center bg-gray-100">
        ...
        <div className="p-8 sm:p-16 lg:p-24">
          ...
          <Link href="/news"><button className="mt-8 inline-block rounded border border-indigo-600 bg-indigo-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500">Get in touch</button></Link>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
    ...
    >
      <div className="flex items-start gap-4">
        <span className="hover:bg-neutral-200 shrink-0 rounded-lg bg-gray-800 p-4">
          <svg
            className="h-5 w-5"
            fill="none"
            stroke="currentColor"
