  ...
  >
    ...
    <div className="flex flex-1 items-center justify-end gap-8">
      ...
      >
        <a
          href="/about"
          className="block h-16 border-b-4 border-transparent leading-[4rem] hover:border-current hover:text-neutral-200"
        >
          About
        </a>
      ...
      <div className="flex items-center">
        <div className="flex items-center border-x border-gray-100">
          <span className="border-e border-e-gray-100">
            <a
              href="/cart"
              className="grid h-16 w-16 place-content-center border-b-4 border-transparent hover:border-neutral-200"
            >
              <svg
                className="h-4 w-4"
                fill="none"
    ...
    <div className="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
      ...
      <div className="relative flex items-center bg-gray-100">
        ...
        <div className="p-8 sm:p-16 lg:p-24">
          ...
          <Link href="/"><button className="mt-8 inline-block rounded border border-indigo-600 bg-indigo-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500">Get in touch</button></Link>
        </div>
      </div>
    </div>
  </div>
...
<section className="bg-neutral-200 text-gray-900">
  <div className="max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
    ...
    >
      <div className="flex items-start gap-4">
        <span className="bg-neutral-200 shrink-0 rounded-lg hover:bg-blue-950 p-4">
          <svg
            className="h-5 w-5"
            fill="none"
            stroke="currentColor"
...
<section className="bg-gray-100">
  <div className="mx-auto max-w-screen-2xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="items-end justify-between sm:flex">
      <div className="max-w-xl">
        <h2 className="text-4xl font-bold tracking-tight sm:text-5xl text-gray-500">
          Read trusted reviews from our customers
        </h2>

        <p className="mt-8 max-w-lg text-gray-900">
    ...
    <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <blockquote className="hover:shadow-2xl flex h-full flex-col justify-between bg-white p-12">
        <div>
        ...
        <footer className="mt-8 text-gray-500">Niam Murphy</footer>
      </blockquote>
...
<section className="dark:bg-neutral-200 dark:text-gray-700">
...
<footer className="footer p-10 dark:bg-neutral-200 dark:text-gray-700">
  <div>
